# Generated by Django 3.1.3 on 2020-11-02 21:18
    ...
    operations = [
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('age', models.PositiveSmallIntegerField(default=0, verbose_name='Возрост')),
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('description', models.TextField(verbose_name='Описание')),
                ('poster', models.ImageField(upload_to='movie_poster/', verbose_name='Постер')),
                ('year', models.PositiveSmallIntegerField(default='', verbose_name='Дата выхода')),
                ('country', models.CharField(max_length=30, verbose_name='Страна')),
                ('world_premiere', models.DateField(default=datetime.date.today, verbose_name='Примьера в мире')),
                ('budget', models.PositiveSmallIntegerField(default=0, help_text='Указывать сумму в долларах', verbose_name='Бюдджет')),
                ('fees_in_usa', models.PositiveSmallIntegerField(default=0, help_text='Указывать сумму в долларах', verbose_name='Сборы в США')),
                ('fees_in_world', models.PositiveSmallIntegerField(default=0, help_text='Указывать сумму в долларах', verbose_name='Сборы по миру')),
                ('url', models.SlugField(max_length=150, unique=True)),
                ...
                ('genge', models.ManyToManyField(to='movies.Genre', verbose_name='Жанры')),
            ],
            options={
                'verbose_name': 'Фильм',
