...
class Actor(models.Model):
    ...
    age = models.PositiveSmallIntegerField("Возрост", default=0)
    description = models.TextField("Описание")
...
class Movie(models.Model):
    ...
    budget = models.PositiveSmallIntegerField("Бюдджет", default=0, help_text="Указывать сумму в долларах")
    fees_in_usa = models.PositiveSmallIntegerField("Сборы в США", default=0, help_text="Указывать сумму в долларах")
    fees_in_world = models.PositiveSmallIntegerField("Сборы по миру", default=0, help_text="Указывать сумму в долларах")
