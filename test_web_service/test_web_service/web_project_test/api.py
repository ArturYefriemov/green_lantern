...
from web_project_test.models import Answer, Question, Quiz, QuizTaker, UsersAnswer
from web_project_test.serializers import MyQuizListSerializer, QuizDetailSerializer, QuizListSerializer, \
    QuizResultSerializer, UsersAnswerSerializer
